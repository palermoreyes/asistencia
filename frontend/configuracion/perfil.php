...
<form enctype="multipart/form-data" method="POST"  autocomplete="off">
    ...
    <input type="text" value="<?php echo  $d->nombre; ?>" class="form-control"  name="txtnaad" required placeholder="ejm: asistente">
    ...
    <input type="email" value="<?php echo  $d->email; ?>" class="form-control"  name="txtcorr" required placeholder="ejm: asistente">
</div>    
    </div> 
    </div>
