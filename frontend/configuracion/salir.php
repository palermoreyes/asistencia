                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card" style="min-height: 485px">
                                <div class="card-header card-header-text">
                                    <h4 class="card-title">¿Estás seguro de que quieres cerrar la sesión?</h4>
                                    <p class="category">cerrarndo la sesión</p>
                                </div>
                                <hr>
...
<div class="form-group">
        <div class="col-sm-12">
            ...
            <a href="../salir.php" class="btn btn-success text-white">Cerrar</a>                     
