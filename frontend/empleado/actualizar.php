                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card" style="min-height: 485px">
                                <div class="card-header card-header-text">
                                    <h4 class="card-title">Actualizar empleados</h4>
                                    <p class="category">Actualizando  empleados</p>
                                </div>
...
<?php
 ...
 $id = $_GET['id'];
 $sentencia = $connect->prepare("SELECT empleado.idemp, empleado.dniem, empleado.nomem, empleado.apeem, cargo.idcar, cargo.nomcar, empleado.programa, empleado.coord, empleado.estado, empleado.fere FROM empleado INNER JOIN cargo ON empleado.idcar = cargo.idcar WHERE empleado.idemp= '$id';");
 $sentencia->execute();
...
<form enctype="multipart/form-data" method="POST"  autocomplete="off">
    ...
    <input type="text" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" maxlength="14" class="form-control" value="<?php echo  $f->dniem; ?>" name="txtnume" required placeholder="ejm: 7887878">
    <input type="hidden" name="txtidemp" value="<?php echo  $f->idemp; ?>">
</div>    
    </div>
    ...
    <input type="text" value="<?php echo  $f->nomem; ?>" onkeypress="return soloLetras(event)" class="form-control"  name="txtnome" required placeholder="ejm: Juan">
</div>    
    </div> 
    </div>
    ...
    <input type="text" value="<?php echo  $f->apeem; ?>" onkeypress="return soloLetras(event)" class="form-control"  name="txtapell" required placeholder="ejm: Perez">
</div>    
    </div>
    ...
    <input type="text" value="<?php echo  $f->programa; ?>" onkeypress="return soloLetras(event)" class="form-control"  name="txtprog" required placeholder="ejm: Triadas">
</div>    
    </div> 
    </div>
    ...
    <div class="col-md-6 col-lg-6">
     <div class="form-group">
     <label for="email">Programa<span class="text-danger">*</span></label>
    <input type="text" value="<?php echo  $f->coord; ?>" onkeypress="return soloLetras(event)" class="form-control"  name="txtcoord" required placeholder="ejm: Pamela Rios">
</div>    
    </div>
    ...
    <select class="form-control" required name="txtcar">
        <option value="<?php echo  $f->idcar; ?>"><?php echo  $f->nomcar; ?></option>
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='stupdempl' class="btn btn-success text-white">Guardar</button>                       
...
<div class="alert alert-warning" style="position: relative;
  ...
  <script src="../../backend/js/sweetalert.js"></script>
   <?php
    include_once '../../backend/php/st_updempl.php'
?>
