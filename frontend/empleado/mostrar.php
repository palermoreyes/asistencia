                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card" style="min-height: 485px">
                                <div class="card-header card-header-text">
                                    ...
                                    <p class="category">Mostrar empleados recientes</p>
                                </div>
                               <br>
<div class="form-group">
    <div class="col-sm-12">       
        <a class="btn btn-danger text-white" href="../empleado/nuevo.php">Nuevo empleado</a>
    </div>
</div>
<br>
 ...
 $sentencia = $connect->prepare("SELECT empleado.idemp, empleado.dniem, empleado.nomem, empleado.apeem, cargo.nomcar, empleado.programa, empleado.coord, empleado.estado, empleado.fere FROM empleado INNER JOIN cargo ON empleado.idcar = cargo.idcar order BY empleado.idemp DESC;");
 $sentencia->execute();
...
if($sentencia){
  while($r = $sentencia->fetchObject()){
   ...
   <?php if(count($data)>0):?>
    ...
    <a class="btn btn-warning text-white" href="../empleado/actualizar.php?id=<?php echo  $g->idemp; ?>">Editar</a>
    <a class="btn btn-danger text-white" href="../empleado/eliminar.php?id=<?php echo  $g->idemp; ?>">Desactivar</a>
                <?php  }   else {?> 
<a class="btn btn-warning text-white" href="../empleado/actualizar.php?id=<?php echo  $g->idemp; ?>">Editar</a>
            <?php  } ?>
