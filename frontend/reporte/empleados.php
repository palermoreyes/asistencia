                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card" style="min-height: 485px">
                                <div class="card-header card-header-text">
                                    ...
                                    <p class="category">Mostrar reportes de los empleados</p>
                                </div>
                               <br>  <!-- Sidebar  

<button class="btn btn-danger btn-lg" onclick="location.href='../reporte/plantilla_empleado.php'">PDF</button>-->
<br>
