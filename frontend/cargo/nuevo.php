                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card" style="min-height: 485px">
                                <div class="card-header card-header-text">
                                    <h4 class="card-title">Nuevos cargos</h4>
                                    <p class="category">Añadiendo nuevos cargos</p>
                                </div>
...
<form enctype="multipart/form-data" method="POST"  autocomplete="off">
    ...
    <input type="text"  class="form-control"  name="txtnacag" required placeholder="ejm: asistente">
</div>    
    </div> 
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='staddcar' class="btn btn-success text-white">Guardar</button>                       
  ...
  <script src="../../backend/js/sweetalert.js"></script>
   <?php
    include_once '../../backend/php/st_stcar.php'
?>
