                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card" style="min-height: 485px">
                                <div class="card-header card-header-text">
                                    <h4 class="card-title">Actualizar cargos</h4>
                                    <p class="category">Actualizando cargos</p>
                                </div>
...
<?php
 ...
 $id = $_GET['id'];
 $sentencia = $connect->prepare("SELECT * FROM cargo  WHERE cargo.idcar= '$id';");
 $sentencia->execute();
...
<form enctype="multipart/form-data" method="POST"  autocomplete="off">
    ...
    <label for="email">Nombre del cargo<span class="text-danger">*</span></label>
    <input type="text" value="<?php echo  $f->nomcar; ?>" class="form-control"  name="txtnacag" required placeholder="ejm: asistente">
    <input type="hidden" value="<?php echo  $f->idcar; ?>" name="txtidcag">
</div>    
    </div> 
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='stupdcar' class="btn btn-success text-white">Guardar</button>                       
...
<div class="alert alert-warning" style="position: relative;
  ...
  <script src="../../backend/js/sweetalert.js"></script>
   <?php
    include_once '../../backend/php/st_updcar.php'
?>
