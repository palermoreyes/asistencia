                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card" style="min-height: 485px">
                                <div class="card-header card-header-text">
                                    <h4 class="card-title">Nueva asistencia</h4>
                                    <p class="category">Añadiendo  asistencia</p>
                                </div>
...
<form enctype="multipart/form-data" method="POST"  autocomplete="off">
    ...
    <label for="email">Nombre de la asistencia<span class="text-danger">*</span></label>
    <input type="text" value="<?php echo  $f->nomas; ?>" class="form-control"  name="txtnamea" required placeholder="ejm: entrada o salida">
    <input type="hidden" value="<?php echo  $f->idasi; ?>" name="txtida">
</div>    
    </div> 
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='stupdasis' class="btn btn-success text-white">Guardar</button>                       
            <a class="btn btn-danger text-white" href="../asistencia/mostrar.php">Cancelar</a>
        </div>
</div>
</form>
<?php endforeach; ?>
...
<div class="alert alert-warning" style="position: relative;
  ...
  <script src="../../backend/js/sweetalert.js"></script>
   <?php
    include_once '../../backend/php/st_updasist.php'
?>
