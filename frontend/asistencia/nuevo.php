...
<form enctype="multipart/form-data" method="POST"  autocomplete="off">
    ...
    <input type="text"  class="form-control"  name="txtnamea" required placeholder="ejm: entrada o salida">
</div>    
    </div> 
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='staddasis' class="btn btn-success text-white">Guardar</button>                       
  ...
  <script src="../../backend/js/sweetalert.js"></script>
   <?php
    include_once '../../backend/php/st_stasist.php'
?>
