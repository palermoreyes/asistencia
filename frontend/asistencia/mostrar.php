...
<div class="body-overlay"></div>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card" style="min-height: 485px">
                                <div class="card-header card-header-text">
                                    ...
                                    <p class="category">Mostrar asistencias recientes</p>
                                </div>
                               <br>
 ...
 $sentencia = $connect->prepare("SELECT * FROM asistencia order BY idasi DESC;");
 $sentencia->execute();
...
if($sentencia){
  while($r = $sentencia->fetchObject()){
   ...
   <?php if(count($data)>0):?>
    ...
    <a class="btn btn-success text-white" href="../asistencia/entrar.php?id=<?php echo  $g->idasi; ?>">Ir al Modulo</a>

    <a class="btn btn-warning text-white" href="../asistencia/actualizar.php?id=<?php echo  $g->idasi; ?>">Editar</a>

    <a class="btn btn-danger text-white" href="../asistencia/eliminar.php?id=<?php echo  $g->idasi; ?>">Eliminar evento</a>
                <?php  }   else {?> 
<a class="btn btn-warning text-white" href="../asistencia/actualizar.php?id=<?php echo  $g->idasi; ?>">Editar</a>
            <?php  } ?>
